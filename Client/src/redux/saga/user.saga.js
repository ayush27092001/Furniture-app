...
import { adduserError, deleteuserError, getUserStart, getUserSuccess, getuserError, loginedUserError, loginedUserSuccess, logoutUserSuccess, profileEditUserError, profileEditUserSuccess, updateuserError } from "../action/user.action";
import { addUserToApi, deleteUserToApi, getUserFromApi, updateUserToApi } from "../services/user.service";
import { loginUserFromApi } from "../services/authentication.service";

function* getUser() {
   try {
      let response = yield getUserFromApi()
